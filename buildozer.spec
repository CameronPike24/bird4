...
source.include_exts = py,png,jpg,kv,atlas,tflite,csv,wav,pickle
...
requirements = python3==3.9.12,kivy,camera4kivy,gestures4kivy,numpy,tflite-runtime,kivymd,requests,urllib3,chardet,idna,hostpython3==3.9.12,kivy_garden.graph,audiostream,shutil
...
android.permissions = INTERNET,RECORD_AUDIO,WAKE_LOCK,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,MANAGE_EXTERNAL_STORAGE
