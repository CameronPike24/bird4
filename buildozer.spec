...
requirements = python3==3.9.12,kivy,camera4kivy,gestures4kivy,numpy,tflite-runtime,kivymd,requests,urllib3,chardet,idna,hostpython3==3.9.12,kivy_garden.graph,audiostream,librosa
